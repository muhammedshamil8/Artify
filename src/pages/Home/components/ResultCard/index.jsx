    ...
    return (
        <div className='relative w-fit h-fit '>
            ...
            <div className='flex items-center justify-center flex-col w-full absolute bottom-8 gap-2'>
                ...
                <div className='border border-black h-[30px] max-w-24 w-full flex items-center justify-center font-bold font-mono text-sm'>
                    {data?.total_score ? <AnimatedCounter from={0} to={data?.total_score} /> : 0}<sub>pts</sub>
                </div>
            </div>
        </div>
    )
